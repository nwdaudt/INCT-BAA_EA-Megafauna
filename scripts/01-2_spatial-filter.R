...
## Spatial filter (only data inside Brazil+Blue Amazon) ####
...
## [CHECK WITH COORDINATORS] Create polygon BR to crop records on land ####
...
## [CHECK WITH COORDINATORS] Crop records within continental areas ####
...
## [CHECK WITH COORDINATORS] In case we crop land records... save it ####
